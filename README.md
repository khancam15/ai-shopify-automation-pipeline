...
├── prompts_example/
│   └── master.txt            # Generic prompt scaffold (brand-agnostic)
│
...
└── outputs/
    ...
    ├── master.txt            # Generated at runtime from brand_guide.md + task prompts
...
> **Niche:** Your target Etsy niche (from `ETSY_NICHE`)  
> **Store:** Generated from market research in Phase 1  
> **Positioning:** Generated from your niche, audience, and competitive gaps
...
### Phase 2 (alt) — Execute Launch (prompt engine)
...
If you change `ETSY_NICHE` and regenerate `outputs/brand_guide.md`, Phase 2 automatically starts a fresh state for the new brand.
