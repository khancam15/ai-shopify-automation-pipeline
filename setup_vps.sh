...
echo "========================================"
echo "  AI Shopify Pipeline — VPS Setup"
echo "========================================"
echo ""
...
echo "     python scripts/shopify_setup.py ← Shopify Admin API token"
...
echo "     cp shopify-pipeline.service /etc/systemd/system/"
echo "     systemctl daemon-reload"
echo "     systemctl enable shopify-pipeline"
echo "     systemctl start shopify-pipeline"
echo ""
echo "  5. Check it's running:"
echo "     systemctl status shopify-pipeline"
